...
export default function useSpreadBalance2(contract, sharePriceContract) {
  ...
  return useMemo(() => {
    return data && sharePrice
      ? truncate(formatEther(data).toString())
      : undefined;
  }, [data, sharePrice]);
}
...
export function useSpreadABalance() {
  ...
  return useSpreadBalance2(contract, sharePriceContract);
}
